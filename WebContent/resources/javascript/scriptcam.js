...
$(document).ready(function() {
				...
				$("#webcam").scriptcam({
					...
					uploadImage : 'resources/images/lo.jpg',
...
;(function($) {
	$.fn.scriptcam=function(options) {
		...
		return this.each(function() {
			...
			if (fileExists(decodeURIComponent(data.path)+'resources/scriptcam.swf')) {
				swfobject.embedSWF(decodeURIComponent(data.path)+'resources/scriptcam.swf', opts.id, newWidth, newHeight, '11.6', false, opts, params);
			}
			else {
