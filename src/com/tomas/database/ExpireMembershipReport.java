...
public class ExpireMembershipReport implements RowMapper<Member>{
	...
	public Member mapRow(ResultSet resultSet, int line) throws SQLException, DataAccessException {
		...
		member.setProgramme(resultSet.getString(4));
		member.setMembershipTo(resultSet.getString(5));
		member.setVisitedTimestamp(resultSet.getString(6));
